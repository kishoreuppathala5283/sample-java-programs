...
/**
 * Precompiled com.github.chrishantha.sample.java-conventions script plugin.
 **/
public class ComGithubChrishanthaSampleJavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComGithubChrishanthaSampleJavaConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGithubChrishanthaSampleJavaConventions").asSubclass(BasicScript.class);
